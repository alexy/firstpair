...
| `rio-grande` | `/Users/alexy/src/book-sources/rio-grande-history` | `build_alexy.py` | Python full-book builder writes PDF/EPUB/MOBI but no `VERSION.md` or HTML. Current FirstPair public package is a preview derived from source artifacts and staged inside FirstPair. This should be wrapped before it is rewritten. |
